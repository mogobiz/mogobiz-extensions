...
class ProductRiver extends AbstractESRiver<Product>{
    ...
    ESMapping defineESMapping() {
        ...
        skuProperties << new ESProperty(name:'stockByDateTime', type:ESClient.TYPE.OBJECT, properties: stockCalendarProperties)
        ...
        new ESMapping(type:getType(),
                ...
                properties: []
                        ...
                        << new ESProperty(name:'creationDate', type:ESClient.TYPE.DATE, index:ESClient.INDEX.NOT_ANALYZED, multilang:false)
